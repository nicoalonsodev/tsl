        ...
        >
          ...
          <div className="mb-4">
            <div className="flex max-h-[54px] cursor-pointer">
              ...
              <input
                ...
                onChange={handleChange}
                className="input-f h-[40px] w-full px-4 pl-10 mt-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                placeholder="Tu número de Whatsapp sin codigo de área"
                required
                style={{
          ...
          <div className="flex items-center justify-center ">
            {isLoading ? (
              ...
              <button
                type="submit"
                className="lol w-4/5 bg-gradient-to-r from-[#5fd3cb] to-[#2f6a66] text-white py-2 rounded-lg mx-auto block text-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#108CE0] hover:scale-110 duration-300 mb-2"
              >
                VER EL MÉTODO AHORA
              </button>
            )}
